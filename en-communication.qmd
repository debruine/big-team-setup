...
I'd recommend setting up an account at each of the major social media platforms, even if you don't intend on using it much, just to make sure no one else can misrepresent your organisation by taking that name. Just set up the account and include a link to your main source of information (e.g., BlueSky or a webpage).
...
* [BlueSky](https://bsky.social) is good for announcements
* Twitter/X is not reputable social media site anymore 
