...
Recomiendo que se cree una cuenta en cada una de las  plataformas de redes sociales principales, incluso si no tienes intención de utilizarla mucho, sólo para asegurarte de que nadie más pueda tergiversar tu organización tomando ese nombre. Basta con crear la cuenta e incluir un enlace a tu principal fuente de comunicación (por ejemplo, BlueSky o una página web).
...
* [BlueSky](https://bsky.social) es bueno para compartir anuncios
